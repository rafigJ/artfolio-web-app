...
import static ru.vsu.cs.artfolio.auth.UserAuthenticationEntryPoint.JWT_EXPIRED;
import static ru.vsu.cs.artfolio.auth.UserAuthenticationEntryPoint.RUNTIME_ERROR;
