...
//        MultipartFile multipartFile = new MockMultipartFile("name", new byte[]{1, 12});
//
//        when(authenticationService.register(requestDto, multipartFile)).thenReturn(responseDto);
//
