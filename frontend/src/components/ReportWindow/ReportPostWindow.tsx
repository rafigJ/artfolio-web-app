...
interface ReportPostWindowProps {
	open: boolean
	setOpen: (state: boolean) => void
}

const ReportPostWindow: FC<ReportPostWindowProps> = ({ open, setOpen }) => {
	...
	const handleOk = () => {
		...
		ReportService.sendPostReport(Number(params.id),
...
export default ReportPostWindow